      ...
      <form onSubmit={handleCalculate} className="mt-6 space-y-8">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 self-end">
            ...
            <button
              type="submit"
              className="rounded-full bg-brand-yellow px-5 py-2 text-sm font-semibold text-neutral-900 shadow-lg shadow-[0_14px_30px_rgba(10,16,26,0.2)] transition hover:bg-brand-yellow-dark focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-900/40 dark:text-neutral-900 dark:hover:bg-brand-yellow-dark"
            >
