...
export default function USP() {
  ...
  return (
    <section id="diensten" data-snap-section className="relative overflow-hidden section-block">
      <div className="absolute inset-0 bg-gradient-to-br from-white/90 via-white/60 to-white/85 dark:from-surface-dark/90 dark:via-surface-dark/70 dark:to-surface-dark/90" aria-hidden />
      <div className="relative content-shell">
        <div className="grid gap-12 md:grid-cols-[minmax(0,1.1fr)_minmax(0,1.7fr)] items-start">
          <motion.div
            ...
            className="section-surface relative rounded-3xl border border-neutral-200/60 bg-white/80 p-8 shadow-lg backdrop-blur dark:border-white/10 dark:bg-white/5"
          >
