...
export default function LookerDashboard() {
  ...
  return (
    ...
    >
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(31,111,139,0.32),_transparent_60%)]"
        aria-hidden
      />
      <div className="relative mx-auto flex max-w-6xl flex-col gap-12 px-6">
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-center">
          ...
          >
            <div
              className="absolute -inset-6 rounded-[2.5rem] bg-gradient-to-br from-brand-blue/35 to-brand-teal/25 blur-3xl"
              aria-hidden
            />
                      ...
                      <svg viewBox="0 0 100 60" className="h-full w-full">
                        <defs>
                          <linearGradient id="revenueGradient" x1="0%" y1="0%" x2="0%" y2="100%">
                            <stop offset="0%" stopColor="rgba(31,111,139,0.65)" />
                            <stop offset="100%" stopColor="rgba(31,111,139,0.08)" />
                          </linearGradient>
                        </defs>
                        <g>
