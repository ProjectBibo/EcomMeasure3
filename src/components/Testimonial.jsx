...
export default function Testimonial() {
  ...
  return (
    <section id="reviews" data-snap-section className="relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-brand-blue/12 via-transparent to-brand-teal/12 dark:from-brand-blue/20 dark:via-transparent dark:to-brand-teal/20" aria-hidden />
