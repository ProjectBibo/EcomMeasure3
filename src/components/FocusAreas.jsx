    ...
    <section className="relative overflow-hidden section-shell">
      ...
      <div className="layout-shell">
        ...
        <motion.div
          ...
          className="mt-6 max-w-3xl space-y-4 prose-limiter"
        >
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {copy.cards.map((card, index) => (
            <motion.article
              ...
              data-tilt-card
              className="group relative flex h-full flex-col overflow-hidden card-surface bg-white/95 p-8 dark:bg-white/5"
            >
              <div
                aria-hidden
