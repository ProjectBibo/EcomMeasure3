...
export default function CroRoiCalculatorPage() {
  ...
  return (
    <>
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-white via-surface-soft to-brand-blue/12 pb-24 pt-28 dark:from-surface-dark dark:via-surface-dark/95 dark:to-brand-blue/20">
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          <motion.span
            ...
            className="inline-flex items-center rounded-full border border-white/60 bg-white/80 px-4 py-1 text-xs font-semibold uppercase tracking-[0.32em] text-brand-blue shadow-sm backdrop-blur dark:border-white/10 dark:bg-white/10 dark:text-brand-blue"
          >
