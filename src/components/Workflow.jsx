  ...
  const items = [
    {
      ...
      text: "Voor je webshop of site dankzij Google Analytics 4, SEO en trend-research.",
    },
    {
    ...
    },
    {
      ...
      text: "Met behulp van ons co-creatieproces en marketinginzichten.",
    },
  ];

  return (
    <section className="max-w-7xl mx-auto px-6 py-20">
      <h2 className="text-2xl font-bold text-brand-blue mb-12">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {items.map((item, i) => (
          <motion.div
            ...
            className="bg-white border border-neutral-200 rounded-xl p-6 shadow transition"
          >
