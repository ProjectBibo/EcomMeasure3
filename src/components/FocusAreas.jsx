...
export default function FocusAreas() {
  ...
  return (
    <section className="relative overflow-hidden bg-surface-soft section-padding dark:bg-surface-dark">
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-3">
          {copy.cards.map((card, index) => (
            <motion.article
              ...
              data-tilt-card
              className="surface-card group relative flex h-full flex-col gap-6 overflow-hidden p-7"
            >
              <div className="flex flex-col gap-4">
                <div>
                  <p className="text-xs font-semibold uppercase tracking-[0.28em] text-brand-blue/80 dark:text-brand-teal/80">
                    {card.subtitle}
                  </p>
