...
export default function ConfirmationVideoAnalyse() {
  return (
    <main className="min-h-screen bg-surface-light">
      <SEO title="Aanvraag ontvangen" description="Bevestiging van je video-analyse aanvraag." />
        ...
        <div className="site-container grid gap-8 lg:grid-cols-2 lg:items-center">
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link to="/measurement" className="button-secondary inline-flex items-center justify-center">
                Bekijk measurement diensten
              </Link>
            </div>
          </div>
            ...
            <div className="space-y-3 text-neutral-700">
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  ...
                  Een bevestiging van de video-analyse aanvraag binnen 1–3 werkdagen.
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1 inline-block h-2 w-2 rounded-full bg-brand-blue" aria-hidden />
                  Mogelijkheid om alvast vervolgvragen of context te delen.
                </li>
              </ul>
            </div>
          </div>
