...
import logo from "../assets/ecommeasure-logo.svg";
          ...
          >
            ...
            >
              <img
                ...
                className={`w-auto transition-[height,width,transform] duration-300 group-hover:-translate-y-0.5 ${
                  isCondensed ? "h-11" : "h-12"
                }`}
              />
            </Link>
