          ...
          {copy.cards.map((card, index) => (
            ...
            >
              ...
              <div className="mt-8 flex flex-1 items-end">
                <Link
                  to={card.to}
                  className="inline-flex items-center gap-2 rounded-full bg-brand-yellow px-5 py-2 text-sm font-semibold text-neutral-900 shadow-[0_18px_40px_rgba(10,16,26,0.2)] transition hover:-translate-y-0.5 hover:bg-brand-yellow-dark hover:shadow-[0_24px_48px_rgba(10,16,26,0.28)] focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-900/40 focus-visible:ring-offset-2 dark:text-neutral-900 dark:hover:bg-brand-yellow-dark dark:focus-visible:ring-offset-surface-dark"
                >
