    ...
    <header className="sticky top-0 z-50">
      ...
      <div className="bg-surface-light dark:bg-surface-dark border-b h-16 relative">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 h-full">
          {/* Logo */}
          <a href="#hero" className="flex items-center relative -mt-[1px]">
            <img
              src="/logo.png"
          ...
          <div className="flex items-center gap-10">
            <nav className="hidden md:flex gap-10 text-neutralInk dark:text-gray-200">
              <div className="flex flex-col leading-tight hover:text-brand-blue cursor-pointer">
                <span className="font-bold text-lg">Meer meten</span>
                <span className="text-base text-neutralInk/60 dark:text-gray-400">
                  Google Analytics 4
                </span>
              </div>
              <div className="flex flex-col leading-tight hover:text-brand-blue cursor-pointer">
                <span className="font-bold text-lg">Optimaliseer je website</span>
                <span className="text-base text-neutralInk/60 dark:text-gray-400">
                  UX / CRO
                </span>
              </div>
              <div className="flex flex-col leading-tight hover:text-brand-blue cursor-pointer">
                <span className="font-bold text-lg">Een nieuwe website</span>
                <span className="text-base text-neutralInk/60 dark:text-gray-400">
            ...
            <a
              href="#contact"
              className="px-5 py-3 rounded-md bg-brand-blue text-white text-base font-semibold shadow hover:brightness-90 transition"
            >
