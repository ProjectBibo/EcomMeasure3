...
export default function LookerStudio() {
  ...
  return (
    <>
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-white via-surface-soft to-brand-yellow/10 pb-24 pt-28 dark:from-surface-dark dark:via-surface-dark/95 dark:to-brand-yellow/20">
        ...
        <div className="relative mx-auto max-w-5xl px-6">
          <motion.span
            ...
            className="inline-flex items-center rounded-full border border-white/70 bg-white/80 px-4 py-1 text-xs font-semibold uppercase tracking-[0.32em] text-brand-blue shadow-sm backdrop-blur dark:border-white/10 dark:bg-white/10 dark:text-brand-yellow"
          >
            {copy.hero.eyebrow}
          </motion.span>
          <motion.h1
