  ...
  return (
    ...
    >
      ...
      <div className="relative section-shell">
        <div className="site-container relative z-10 flex flex-col gap-8 lg:gap-10 min-h-[70vh] lg:min-h-[78vh] lg:pr-[28rem] xl:pr-[34rem]">
          <div className="relative max-w-3xl flex flex-col items-start gap-5 md:gap-6 lg:gap-7 text-left vt-hero-visual">
            <motion.span
            ...
            >
              ...
              <span className="relative mt-3 grid justify-items-start text-left h-[2.5em] overflow-hidden">
                <span
