export const translations = {
  nl: {
    ...
    aiDemo: {
      badge: "QuickScan",
      title: "1 gratis pagina quickscan",
      description: "Vraag een snelle review aan en ontvang concrete optimalisatie-inzichten.",
      urlLabel: "Vul de pagina-URL in die je wilt laten quickscannen",
      urlPlaceholder: "https://www.jouwsite.nl/pagina",
      urlHelper: "We gebruiken je link en e-mailadres alleen om je quickscan te versturen.",
      urlError: "Voer een geldige URL in.",
      ...
      emailFreemailError: "Gebruik bij voorkeur je zakelijke e-mailadres.",
      submitButton: "Verzenden",
      submitButtonLoading: "Verzenden…",
      successTitle: "Aanvraag ontvangen",
      successBody: "We gaan je pagina analyseren. Je hoort snel van ons via e-mail.",
      submitError: "Er ging iets mis bij het versturen. Probeer het opnieuw.",
    },
    workflow: {
      badge: "Aanpak",
  ...
  en: {
    ...
    aiDemo: {
      badge: "QuickScan",
      title: "1-page QuickScan (free)",
      description: "Request a rapid review and receive practical optimisation insights.",
      urlLabel: "Enter the page URL you want quick-scanned",
      urlPlaceholder: "https://www.yoursite.com/page",
      urlHelper: "We only use your link and email address to send your quickscan.",
      urlError: "Please enter a valid URL.",
      primaryCta: "Request your free QuickScan",
      emailLabel: "Business email address",
      emailPlaceholder: "name@company.com",
      emailError: "Enter a valid email address.",
      emailFreemailError: "Please use your business email address.",
      submitButton: "Send",
      submitButtonLoading: "Sending…",
      successTitle: "Request received",
      successBody: "We'll analyse your page and get back to you via email soon.",
