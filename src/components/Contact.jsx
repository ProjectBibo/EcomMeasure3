...
export default function Contact() {
  return (
    <section
      id="contact"
      className="relative py-24 sm:py-28 bg-gradient-to-br from-brand-blue/5 via-brand-teal/5 to-brand-yellow/5 dark:from-surface-dark dark:via-surface-dark/95 dark:to-surface-dark"
    >
      ...
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        <motion.div
          ...
          className="mt-16 rounded-3xl bg-neutral-900 px-6 py-10 text-white shadow-xl dark:bg-neutral-800"
        >
