...
export default function BayesianCalculator() {
  ...
  return (
    <>
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-white via-surface-soft to-brand-teal/12 pb-24 pt-28 dark:from-surface-dark dark:via-surface-dark/95 dark:to-brand-teal/20">
