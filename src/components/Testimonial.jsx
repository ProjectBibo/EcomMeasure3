...
export default function Testimonial() {
  ...
  return (
    <section id="reviews" data-snap-section className="relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-brand-blue/12 via-transparent to-brand-teal/12 " aria-hidden />
      <div className="relative max-w-6xl mx-auto px-6 py-24 sm:py-28 grid gap-12 lg:grid-cols-[1.1fr_1fr] lg:items-center">
        <motion.div
          ...
          data-tilt-card
          className="group relative overflow-hidden rounded-3xl border border-white/60 bg-white/80 p-8 shadow-[22px_34px_85px_rgba(15,23,42,0.18)] backdrop-blur-xl transition-[box-shadow,transform] duration-500 hover:shadow-[26px_42px_110px_rgba(15,23,42,0.26)] focus-visible:shadow-[26px_42px_110px_rgba(15,23,42,0.26)] "
        >
          ...
          >
            ...
            <footer className="text-sm uppercase tracking-[0.2em] text-neutral-500 ">{t.author}</footer>
          </motion.blockquote>
          <div className="mt-8 grid gap-4 sm:grid-cols-3 text-xs uppercase tracking-[0.2em] text-neutral-600 ">
            {t.metrics.map((metric) => (
              <div
                key={metric.label}
                className="rounded-xl border border-white/70 bg-white/70 p-4 text-center shadow-[inset_0_1px_0_rgba(255,255,255,0.8),0_18px_40px_rgba(15,23,42,0.12)] backdrop-blur "
              >
        ...
        >
          <iframe
            ...
            allowFullScreen
          ></iframe>
          <div className="absolute inset-x-6 bottom-6 rounded-2xl border border-white/40 bg-white/80 px-4 py-3 text-center text-xs font-semibold uppercase tracking-[0.24em] text-neutral-800 shadow-sm backdrop-blur ">
            {t.videoCta}
          </div>
        </motion.div>
      </div>
