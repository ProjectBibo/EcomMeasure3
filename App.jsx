...
import { ArrowRight, BarChart3, Shield, Link2, Gauge, Timer, Rocket, HelpCircle, Mail, Phone, MapPin, Star } from "lucide-react";
      ...
      <section id="features" className="py-24 bg-neutral-900">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Feature icon={<Shield />} title="Privacyproof" desc="Consent Mode v2 en cookiebanner conform EU-regels. Rust en compliance." />
      ...
      <section id="dashboard" className="py-24">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="rounded-xl overflow-hidden border border-neutral-800">
            <img src="https://lookerstudio.google.com/embed/reporting/sample-dashboard" alt="Voorbeeld dashboard" className="w-full h-96 object-cover" />
          </div>
        </div>
      </section>
