...
export default function Testimonial() {
  return (
    <section id="testimonial" className="bg-surface.soft py-20">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 px-6 items-center">
        ...
        <motion.div
          ...
          className="aspect-video rounded-xl overflow-hidden border border-neutral-200 shadow"
        >
          <iframe
            width="100%"
            height="100%"
        ...
        <div>
          ...
          <motion.blockquote
            ...
            className="bg-white border border-neutral-200 rounded-xl p-6 mb-4 shadow"
          >
            <p className="mb-3 text-neutralInk/80">
