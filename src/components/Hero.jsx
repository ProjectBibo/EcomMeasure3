    ...
    <section id="hero" data-snap-section className="relative isolate overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-28 sm:py-32 flex flex-col items-center text-center gap-12 vt-hero-visual">
        ...
        >
          ...
          <Link
            to="/measurement"
            className="secondary-btn text-sm font-semibold"
        ...
        >
          {t.stats.map((item) => (
            <div
              key={item.label}
              data-tilt-card
              className="surface-card group relative flex h-full flex-col gap-3 overflow-hidden p-6 text-left"
            >
              <div className="text-xs font-semibold uppercase tracking-[0.22em] text-neutral-500 dark:text-gray-400">{item.label}</div>
              <div className="text-3xl font-bold text-brand-blue dark:text-brand-blue">{item.value}</div>
              <p className="text-sm text-neutral-600 dark:text-gray-300">{item.helper}</p>
            </div>
          ))}
        </motion.div>
        ...
        <motion.div
          ...
          data-tilt-card
          className="surface-card vt-hero-media relative w-full p-8 text-left backdrop-blur-md"
        >
